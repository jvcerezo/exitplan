...
const INCOME_MULTIPLE = 10; // recommended life coverage = 10x annual income
        ...
        <div className="grid gap-3 grid-cols-3">
          ...
          <Card className={`rounded-2xl border ${summary.renewingSoon.length > 0 ? "border-orange-500/20 bg-orange-500/5" : "border-border/60"}`}>
            <CardContent className="p-4">
              ...
              <p className={`text-xl font-bold mt-0.5 ${summary.renewingSoon.length > 0 ? "text-orange-500" : ""}`}>
