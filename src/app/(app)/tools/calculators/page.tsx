...
const TABS = [
  { id: "loan", label: "Loan Amortization", desc: "Monthly payment and total interest on any loan" },
  { id: "compound", label: "Compound Interest", desc: "Grow your money with regular contributions" },
  { id: "fire", label: "FIRE Calculator", desc: "How long until you can retire early?" },
];
    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      <Card className="rounded-2xl border border-border/60">
        <CardHeader className="pb-3">
          <CardTitle className="text-sm font-semibold">{TABS.find((t) => t.id === activeTab)?.label}</CardTitle>
          <CardDescription className="text-xs">{TABS.find((t) => t.id === activeTab)?.desc}</CardDescription>
        </CardHeader>
        <CardContent>
